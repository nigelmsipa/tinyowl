#!/usr/bin/env python3
"""
TinyOwl Clean WEB (World English Bible) Ingestion
Handles the clean format: "Genesis 1:1\tVerse text"
"""
...
class CleanWEBIngestor:
    """Clean WEB ingestion with simple tab-delimited format"""
    ...
    def ingest_web_bible(self, filepath: str, translation_id: str = "web") -> Dict[str, Any]:
        """Complete bulletproof ingestion of clean WEB format"""
        print("🎯 Starting Clean WEB Ingestion Pipeline")
        print("=" * 60)
    ...
    def _parse_clean_format(self, filepath: str, translation_id: str, report: Dict) -> Dict[str, Dict[int, Dict[int, str]]]:
        ...
        for line_num, line in enumerate(lines):
            ...
            # Skip header lines
            if not line or line == 'WEB' or 'World English Bible' in line:
                continue
...
if __name__ == "__main__":
    ingestor = CleanWEBIngestor()
    
    web_path = "/home/nigel/Downloads/Web.txt"
    report = ingestor.ingest_web_bible(web_path, "web")
    
    # Save report
    with open("domains/theology/processed/web_clean_ingestion_report.json", "w") as f:
        json.dump(report, f, indent=2)
    
    print(f"\n📋 Report saved to: domains/theology/processed/web_clean_ingestion_report.json")