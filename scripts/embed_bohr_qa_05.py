#!/usr/bin/env python3
"""
Generate BGE-large-en-v1.5 embeddings for Stephen Bohr Q&A 05 chunks
...
CHUNKS_FILE = TINYOWL_ROOT / "domains/theology/chunks/stephen_bohr_qa_05_chunks.json"
...
def main():
    print("=" * 60)
    print("Embedding Stephen Bohr Q&A 05 Chunks")
    print("=" * 60)
    ...
    new_added = len(chunks)
    print(f"\n✓ Embedding complete!")
    print(f"  Collection: {COLLECTION_NAME}")
    print(f"  Total documents: {final_count}")
    print(f"  New documents added: {new_added}")
