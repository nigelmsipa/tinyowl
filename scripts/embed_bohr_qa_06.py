#!/usr/bin/env python3
"""
Generate BGE-large-en-v1.5 embeddings for Stephen Bohr Q&A 06 chunks
...
CHUNKS_FILE = TINYOWL_ROOT / "domains/theology/chunks/stephen_bohr_qa_06_chunks.json"
...
def main():
    print("=" * 60)
    print("Embedding Stephen Bohr Q&A 06 Chunks")
    print("=" * 60)
