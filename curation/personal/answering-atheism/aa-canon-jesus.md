---
title: "5 Things About Jesus That Aren't So Great — Canonical Responses"
source_video: "5 Things About Jesus That Aren't So Great (including his supposed 'sacrifice')"
url: https://www.youtube.com/watch?v=ziSORH5GTOA
speaker: Promise Backland (ex-Christian, atheist)
project: answering-atheism
type: apologetic-response
derived_entries: 6
---
...
*The Desire of Ages* is explicit: Christ's primary suffering was not physical. The real agony was the crushing weight of human sin and complete separation from the Father's love — what Ellen White describes as the second death. At Matthew 27:46, she writes, Christ could not see through the portals of the tomb. He faced that abyss by faith, not by sight.
...
*Christ's Object Lessons* opens with exactly this question. Ellen White argues Jesus used parables to protect truth from those who would weaponize it and to make truth memorable across generations. Stories outlive propositions. The parables have traveled 2,000 years in dozens of languages because they engage the imagination rather than merely asserting a position. The survival of the teaching is itself evidence against the bad communicator charge.
...
- `question`: Jesus never condemned slavery. He came to fulfill laws that regulated slave-beating. He used slaves in parables. An all-knowing God should have known his words would be used to justify centuries of slavery.
- `scripture_basis`: Matthew 5:17-20; Exodus 21:20-27; Galatians 3:28; Philemon 1:10-16; John 8:36
- `secondary_support`: Ellen G. White on human dignity and the gospel's abolitionist trajectory
...
Ellen White teaches that the gospel inherently undermines slavery by establishing the absolute equality of all humans before God. The principles of Christ's kingdom, when fully realized, dismantle all systems of human oppression. She addressed slavery directly, writing during and after the Civil War.

**Historical / Scholarly**

There is no explicit verse in the Gospels where Jesus says "do not own other humans as slaves." That text does not exist and should not be invented. The honest answer is the trajectory argument: no explicit condemnation, but a moral logic — every person made in God's image, Christ dying for all equally, love your neighbor as yourself — that made the institution unsustainable wherever the gospel was taken seriously. The fact that Christians misused Scripture to justify slavery is a genuine stain; but the same corpus drove abolition.

The hardest version of the objection — if Jesus was all-knowing and knew his words would justify centuries of chattel slavery, why not say it explicitly — deserves a direct answer: we do not fully know. It is a genuine absence in the Gospel record. But the abolitionists sat with that same silence and followed the gospel's logic where it led, against the culture, against the slaveholders, against the churches that supported them. The absence of an explicit condemnation did not stop William Wilberforce or Frederick Douglass. The trajectory was in the text. They found it.

**Pastoral**

There is no explicit anti-slavery verse — say so plainly. The silence is real and should be named, because naming it is more honest than pretending it away, and honesty is more persuasive than defensiveness. Then show that the same corpus that contains the silence drove the abolitionist movement. Her objection lands hardest against the church's historical application of the gospel — and she is largely right about that. The distinction that matters is between the gospel and its abusers: the gospel's own logic always pointed toward abolition, and the people who followed it there did the work.

---

## Entry `aa-017`

- `question`: Jesus made cult-like demands — hate your family, let the dead bury their dead. People have actually disowned their families over these sayings. A God who values community and family would not speak this way.
- `scripture_basis`: Luke 14:26; Matthew 10:37; Luke 9:60; Mark 5:19; John 6:67; Matthew 15:4; John 19:26-27
- `secondary_support`: Ellen G. White on priority of God; distinction between heart allegiance and cult control
...
Ellen White frames "hate your family" as absolute priority, not literal hatred. Where loyalty to family would require compromising truth, the disciple must choose Christ even if it brings division. This is a description of the cost discipleship sometimes carries — not a command to pursue that cost as a goal.
...
Family disownment citing these texts is a real harm and should not be defended. Name it as misuse. The genuine cost of discipleship — that following truth sometimes creates relational distance — is real and should not be minimized either. But that cost is imposed by the situation, not pursued as a goal. The Jesus who told his followers to hate their families is the same Jesus who, while dying, made arrangements for his mother's care.

---

## Entry `aa-018`

- `question`: The Golden Rule (Matthew 7:12) is oversimplified. Treating others how *you* want to be treated ignores that people want different things. A better rule: treat others how *they* want to be treated.
- `scripture_basis`: Matthew 7:12; Luke 6:31; Leviticus 19:18; Romans 13:9-10
- `secondary_support`: Ellen G. White, *Thoughts from the Mount of Blessing*

### Answer

**Scripture**

Matthew 7:12 — "whatever you wish that others would do to you, do also to them, for this is the Law and the Prophets." Jesus frames this as the summation of the entire Law and Prophets — a principle that generates specific rules, not a rule that replaces judgment. Leviticus 19:18 ("love your neighbor *as yourself*") has the same structure: your own interests and needs as the reference point for how to treat others, not as an assumption that others share those interests.

**Spirit of Prophecy**

Ellen White frames the Golden Rule as the foundational principle of heaven's government — not a social tip but the operative law of a universe built on love. Applied with wisdom it requires knowing the other person, which is itself treating them as you would want to be treated: with attention to your actual needs.
...
- `question`: Jesus only had three years of recorded ministry and performed selective small miracles. If he could heal every sick child, he should have. Other philosophers offer equally interesting teaching. Without the supernatural claims, he is mildly interesting at best.
- `scripture_basis`: John 21:25; John 20:30-31; Mark 3:13-15; John 18:36; John 6:26-27
- `secondary_support`: Ellen G. White, *The Desire of Ages* (scope and purpose of ministry)

### Answer

**Scripture**

John 21:25 is explicit: "there are also many other things that Jesus did… the world itself could not contain the books." John 20:30-31 states the selection principle: "these are written so that you may believe." The record is curated for persuasion, not comprehensiveness. The claim that Jesus "didn't do much" is an argument from a deliberately selective record. He also extended his work through others from the start — Mark 3:13-15 records him sending out the Twelve to preach and heal.

**Spirit of Prophecy**

Ellen White explains that Christ did not heal every sick person in Judea because his primary mission was spiritual salvation, not universal physical relief. John 6 records this tension explicitly — the crowd followed for the bread, and Jesus withdrew rather than becoming a miracle dispenser. He performed enough to provide sufficient evidence without turning the ministry into spectacle.
...
Answers synthesized from three prior research layers:
- `AA-RESEARCH-PLAN.md` — question extraction and research prompts
- `AA-SOP-LAYER.md` — Ellen G. White material from SOP research pass
- `AA-SCHOLAR-LAYER.md` — biblical and historical/scholarly material

All six questions are drawn from the source video transcript. The Pastoral layer in each entry is curator-supplied — it represents the recommended posture for engaging someone with Promise Backland's specific history, not a transcript of her words. NotebookLM source references in `AA-SCHOLAR-LAYER.md` do not resolve outside that environment; the underlying arguments have been independently verified.
